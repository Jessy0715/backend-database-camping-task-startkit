...
SELECT 
user_id, SUM(credit_amount) AS total
...
FROM "COURSE_BOOKING"
WHERE 
"COURSE_BOOKING".status NOT IN ('即將授課','課程已取消')
...
FROM (
 SELECT user_id, SUM(credit_amount) AS total_credit
  FROM "CREDIT_PURCHASE"
...
FROM "COURSE_BOOKING"
WHERE "COURSE_BOOKING".created_at >= '2024-12-01 00:00:00' AND "COURSE_BOOKING".created_at <= '2024-12-31 23:59:59'
